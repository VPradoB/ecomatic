    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Registrar un usuario</h4>
            </div>
            <div class="modal-body">
                <form action="" id="addForm">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="email" type="text" placeholder="example@example.com" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" name="direction" placeholder="" required>
                    </div>
                    <div class="form-group">
