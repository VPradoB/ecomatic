...
<header class="main-header">
    ...
    <a href="{{ url('/home') }}" class="logo">
        ...
        <img src="{{asset('img/ecoMaticImagen.png')}}" width="30px" alt="">
        <!-- logo for regular state and mobile devices -->
        <img src="{{asset('img/ecoMaticLogo.png')}}" width="120px" alt="">
    </a>
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <img src="{{asset('img/default.png')}}" width="10px" class="img-circle" alt="User Image" />
                                <p>
                                    {{ Auth::user()->name }}
                            ...
                            <li class="user-footer">
                                ...
                                --}}
                                <div class="">
                                    <a href="{{ url('/logout') }}" class="btn btn-default btn-block">{{ trans('adminlte_lang::message.signout') }}</a>
                                </div>
                            </li>
                        </ul>
                    </li>
